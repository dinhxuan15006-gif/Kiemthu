...
public class testfull {
    ...
    @Test(description = "1. Đăng nhập thành công (Sử dụng Mock hoàn toàn)")
    public void TC01_LoginSuccess() throws ServletException, IOException, Exception {
        // 1. Tạo dữ liệu giả
        ...
        // 3. DÙNG REFLECTION ĐỂ TIÊM MOCK DAO VÀO SERVLET
        // (Giả sử trong LoginServlet bạn đặt tên biến là 'dao' hoặc 'userDAO')
        try {
            Field field = LoginServlet.class.getDeclaredField("dao"); // Thay "dao" bằng tên biến DAO trong LoginServlet của bạn
            field.setAccessible(true);
            field.set(loginServlet, mockedDAO);
        } catch (NoSuchFieldException e) {
            // Nếu servlet dùng tên biến khác, bạn hãy kiểm tra lại file LoginServlet.java
        }
        ...
        // 5. Chạy logic Servlet
        loginServlet.doPost(request, response);

        // 6. Kiểm tra: Nếu đúng nó phải chuyển hướng về trang index
    ...
    public void TC04_FindUserValid() {
        User user = userDAO.findById("nhat");
